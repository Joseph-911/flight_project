...
airline_url_patterns = [
    ...
    path('flights/edit/<str:pk>/', views_airline.update_flight, name='company-flight-edit'),
    path('flights/delete/<str:pk>/', views_airline.remove_flight, name='company-flight-remove'),
